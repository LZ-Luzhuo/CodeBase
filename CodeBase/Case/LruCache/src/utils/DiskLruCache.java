...
import com.example.lrucachedemo.BuildConfig;
...
public class DiskLruCache {
    ...
    private final int maxCacheItemSize = 60; // 64 item default  //默认缓存60条数据
    private long maxCacheByteSize = 1024 * 1024 * 5; // 5MB default //默认缓存5M数据
