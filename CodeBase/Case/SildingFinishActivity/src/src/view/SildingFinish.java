package com.example.sildingfinishdemo.view;
 ...
 * =================================================
 **/
public class SildingFinish extends FrameLayout {
	private static final String TAG = SildingFinish.class.getSimpleName();
	private View mContentView;
	private int mTouchSlop;  //滑动的距离
	private int downX;
	private int downY;
	private int tempX;
	private Scroller mScroller; //实现view平滑的类
	private int viewWidth;
	private boolean isSilding; //是否滑动
	private boolean isFinish;
	private Drawable mShadowDrawable;
	private Activity mActivity;
	private List<ViewPager> mViewPagers = new LinkedList<ViewPager>(); //存放ViewPager的集合
	
	public SildingFinish(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SildingFinish(Context context, AttributeSet attrs, int defStyle) {
