package com.example.chart.widget.piechart;
...
public class PieChartView extends DemoView implements Runnable{
	 ...
	 * 饼图颜色
	 */
	public static int[] cocors = new int[]{Color.rgb(90, 79, 88),Color.rgb(60, 173, 213),Color.rgb(191, 79, 75),Color.rgb(155, 187, 90),Color.rgb(242, 167, 69)};
